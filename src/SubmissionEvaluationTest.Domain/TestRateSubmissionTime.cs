...
{
    [TestFixture]
    public class TestRateSubmissionTime
    {
        [Test]
        public void IsNewSubmissionBetter_Should_Return_True_When_Newer_Is_Better()
        {
            var newSub = new SubmissionEntry {Date = new DateTime(2014, 1, 1)};
            var oldSub = new SubmissionEntry {Date = new DateTime(2015, 05, 20)};
            var rater = new RateSubmissionTime();
        ...
        {
            var s1 = new SubmissionEntry {Date = DateTime.Parse("1.1.2015")};
            var submitters = new List<SubmissionEntry> {s1};

            var ret = new RateSubmissionTime();
        ...
        {
            var s1 = new SubmissionEntry {Date = DateTime.Parse("1.1.2015")};
            var s2 = new SubmissionEntry {Date = DateTime.Parse("1.1.2015")};
        ...
        {
            var s1 = new SubmissionEntry {Date = DateTime.Parse("1.1.2015")};
            var s2 = new SubmissionEntry {Date = DateTime.Parse("2.1.2015")};
            var submitters = new List<SubmissionEntry> {s1, s2};
        ...
        public void UpdatePoints_Should_Set_Points_When_3_Submitters_Are_Passed()
        {
            var s1 = new SubmissionEntry {Date = DateTime.Parse("1.1.2015")};
            var s2 = new SubmissionEntry {Date = DateTime.Parse("2.1.2015")};
            var s3 = new SubmissionEntry {Date = DateTime.Parse("3.1.2015")};
        ...
        public void UpdatePoints_Should_Set_Points_When_5_Submitters_with_3_same_Are_Passed()
        {
            var s1 = new SubmissionEntry {Date = DateTime.Parse("1.1.2015")};
            var s2 = new SubmissionEntry {Date = DateTime.Parse("2.1.2015")};
            var s3 = new SubmissionEntry {Date = DateTime.Parse("2.1.2015")};
            var s4 = new SubmissionEntry {Date = DateTime.Parse("2.1.2015")};
            var s5 = new SubmissionEntry {Date = DateTime.Parse("3.1.2015")};
        ...
        public void UpdateRanking_Should_Set_Rank_When_4_Submitters_And_2_Same_Are_Passed()
        {
            ...
            var s2 = new SubmissionEntry {Date = DateTime.Parse("2.1.2015")};
            var s3 = new SubmissionEntry {Date = DateTime.Parse("2.1.2015")};
            var s4 = new SubmissionEntry {Date = DateTime.Parse("3.1.2015")};
