(function() {
    window.BlazorInputFile = {
        init: function init(elem, componentInstance) {
            ...
            elem.addEventListener("change",
                function handleInputFileChange(event) {
                    ...
                    var fileList = Array.prototype.map.call(elem.files,
                        function(file) {
                            var result = {
                                id: ++nextFileId,
                    ...
                    componentInstance.invokeMethodAsync("NotifyChange", fileList).then(null,
                        function(err) {
                            throw new Error(err);
                        });
                });
        ...
        ensureArrayBufferReadyForSharedMemoryInterop: function
            ensureArrayBufferReadyForSharedMemoryInterop(elem, fileId) {
